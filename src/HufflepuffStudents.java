public class HufflepuffStudents extends HogwartsStudents {
    ...
    private int loyal;
    private int honest;
    public HufflepuffStudents(String name, String surname, int magic, int moving, int industrious, int loyal, int honest) {
    ...
    public int sumH(){
        return getIndustrious()+getLoyal()+getHonest();
    }
    ...
    public static void  bestHufflepuff (HufflepuffStudents student1, HufflepuffStudents student2){
